...
export const Route = createFileRoute("/login")({
  head: () => ({
    meta: [
      { title: "Sign in — Lumen" },
      { name: "description", content: "Welcome back to your skin transformation." },
    ],
  }),
  component: LoginPage,
});
    ...
    <div className="min-h-screen bg-background lg:grid lg:grid-cols-2">
        ...
        <div className="relative z-10 flex h-full flex-col justify-between p-12">
          ...
          <div className="max-w-md">
            ...
            <h2 className="font-display text-4xl font-semibold leading-[1.1] tracking-tight text-foreground">
              Your skin remembers every choice you make.
            </h2>
            <p className="mt-5 text-base leading-relaxed text-foreground/70">
              Welcome back. Pick up your protocol where you left off — calmer, clearer skin is built one ritual at a time.
            </p>
      ...
      <div className="flex min-h-screen items-center justify-center px-6 py-12 lg:min-h-0">
        <div className="w-full max-w-md">
          ...
          <h1 className="mt-3 font-display text-4xl font-semibold tracking-tight">Sign in to Lumen</h1>
          <p className="mt-2 text-muted-foreground">Continue your transformation.</p>
          ...
          <form className="mt-10 space-y-5">
            ...
            <button
              type="button"
              className="flex h-12 w-full items-center justify-center gap-3 rounded-2xl border border-border bg-card text-sm font-medium shadow-soft transition-colors hover:bg-muted"
            >
