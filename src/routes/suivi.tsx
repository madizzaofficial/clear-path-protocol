  ...
  return (
    <AppShell>
      <main className="mx-auto max-w-7xl px-4 pb-28 pt-8 sm:px-6">
        ...
        {/* ── État d'attente (aucune routine assignée) ── */}
        {!data.loading && (data.totalRoutineSteps ?? 0) === 0 && (
          <div className="mx-auto max-w-lg space-y-5">
            ...
            {/* Section contact */}
            <div className="rounded-3xl border border-border/60 bg-card p-7 shadow-soft">
              <h3 className="font-semibold text-base">Une question ?</h3>
              <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                Si tu as une question concernant ton analyse ou ton accès à la plateforme, tu peux me contacter directement.
              </p>
              <a
                href={WHATSAPP_URL}
                target="_blank"
                rel="noopener noreferrer"
                className="mt-5 flex w-full items-center justify-center gap-2.5 rounded-2xl bg-[#25D366] px-5 py-3.5 text-sm font-semibold text-white shadow-soft transition-opacity hover:opacity-90"
              >
        ...
        {/*
          Desktop 3-col grid — visible uniquement quand la routine est disponible:
        ...
        */}
        {(data.totalRoutineSteps ?? 0) > 0 && <div className="space-y-4 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-6">
